...
export default function Protocolo() {
  ...
  const handleLoad = () => {
    ...
    const mapa = {
      ...
      EndCEP: dados.endCEP || dados.cep,
      EndLogradouro: dados.endLogradouro || dados.endereco,
      EndNumero: dados.endNumero || dados.numero,
      EndComplemento: dados.endComplemento || dados.complemento,
      EndBairro: dados.endBairro || dados.bairro,
      EndCidade: dados.endCidade || dados.cidade,
      EndUF: dados.endUF || dados.uf,
